...
def ocr_pdf(pdf_path: str | Path, language_hints: list[str] | None = None) -> list[str]:
    """
    Convert a PDF to images and OCR every page.

    Args:
        pdf_path:       Path to the scanned PDF.
        language_hints: BCP-47 language codes.

    Returns:
        List of OCR text strings, one entry per page.
    """
